(function initCaesarCipher(global) {
  ...
  /**
   * Estimate how likely a string is natural plaintext by scoring common words, n-grams, and letter-frequency heuristics.
   * @param {string} text - Candidate plaintext to evaluate.
   * @return {number} A numeric confidence score; higher values indicate the text is more similar to natural English/German. 
   */
